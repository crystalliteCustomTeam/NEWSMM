                    ...
                    <div className="rounded-2xl bg-primary py-[100px] relative z-10 sm:w-[calc(100%-60px)] ml-auto">
                        ...
                        <div className="max-w-[550px] xl:max-w-[735px] mx-auto text-white relative lg:left-[100px] text-center lg:text-left">
                            ...
                            <div className="flex flex-col md:flex-row gap-5 justify-center lg:justify-start">
                                ...
                                <div dangerouslySetInnerHTML={{
                                    __html: `<a href="javascript:;" onclick="parent.LC_API.open_chat_window();return false;" class="text-[14px] xl:text-[16px] inline-block font-semibold px-[10] xl:px-[20px] py-[30px] lg:py-[40px] bg-transparent border-2 border-white hover:bg-secondary hover:border-secondary transition-all duration-300 hover:py-[10px] w-[330px] md:w-max">
