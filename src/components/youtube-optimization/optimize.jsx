...
// Media
import one from "media/youtube-optimization/optimize/1.png"
import two from "media/youtube-optimization/optimize/2.png"
import three from "media/youtube-optimization/optimize/3.png"

const data = [
    {
        icon: one,
        title: "Increased Visibility",
        para: "Achieve higher visibility with optimized SEO and targeted content strategies."
    },
    {
        icon: two,
        title: "Higher Engagement",
        para: "Boost engagement with compelling content, strategic CTAs, and interactive elements."
    },
    {
        icon: three,
        title: "More Subscribers",
        para: "Attract more subscribers through engaging content, consistent posting, and optimization."
    }
]
