                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 xl:divide-x-2 2xl:gap-x-10 items-center gap-5">
                        <div className="">
                            ...
                            <div className="text-[14px] sm:text-[16px] leading-relaxed sm:leading-normal grid grid-cols-1 gap-y-5 mb-7 text-text sm:max-w-[90%] md:max-w-full lg:max-w-[85%] xl:max-w-[95%] 2xl:max-w-[95%]">
                                <p>
                                    Harness the power of influencers for unmatched brand growth. By collaborating with influential voices, you can amplify your message, reach new audiences, and foster authentic connections that drive engagement and loyalty. Experience exponential growth and elevate your brand to new heights with strategic influencer partnerships, ensuring your brand stands out in a competitive market.
                                </p>
                            </div>
