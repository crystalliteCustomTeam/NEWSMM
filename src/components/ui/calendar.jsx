  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-zinc-50 hover:bg-primary hover:text-zinc-50 focus:bg-primary focus:text-zinc-50 dark:bg-zinc-50 dark:text-primary dark:hover:bg-zinc-50 dark:hover:text-primary dark:focus:bg-zinc-50 dark:focus:text-primary",
        day_today: "bg-zinc-100 text-primary dark:bg-zinc-800 dark:text-zinc-50",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-zinc-100 aria-selected:text-primary dark:aria-selected:bg-zinc-800 dark:aria-selected:text-zinc-50",
